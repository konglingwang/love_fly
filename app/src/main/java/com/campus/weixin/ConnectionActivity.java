...
//                                DJISDKManager.getInstance().enableBridgeModeWithBridgeAppIP("172.20.10.7");
...
//        mBtnOpen.setEnabled(false);
        ...
        speachButton = (Button)findViewById(R.id.speachView);
        speachButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Log.i("匿名内部类", "点击事件");
//                ActivityWakeUp activityWakeUp =  new ActivityWakeUp();
//                Intent result = new Intent();
//                result.setClassName("com.campus.weixin","com.campus.weixin.ActivityWakeUp");
...
//                wpspeach();
    ...
    private Intent activityIntent(String pkg, String componentName) {
        Intent result = new Intent();
        result.putExtra("name1", componentName);
        result.putExtra("name2", componentName);
