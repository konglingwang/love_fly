...
//    Button land;
    ...
    public RecogEventAdapter(MainActivity mainActivity, IRecogListener listener) {
    ...
    public void onEvent(String name, String params, byte[] data, int offset, int length) {
        ...
        if (params!=null && mainActivity!=null) {
            View view = null;
            if (params.contains("向左转向")) {
                view = mainActivity.findViewById(R.id.turn_left);

                System.out.println("向左转向");
            } else if (params.contains("向右转向")) {
                System.out.println("向右转向");
                view = mainActivity.findViewById(R.id.turn_right);


            } else if (params.contains("向前飞行") ){
                System.out.println("向前飞行");

                view = mainActivity.findViewById(R.id.forward);


            } else if (params.contains("向后飞行") ){
                System.out.println("向后飞行");
                view = mainActivity.findViewById(R.id.backward);


            } else if (params.contains("最美的女生")) {
                System.out.println("最美的女生");
                //TODO
                view = mainActivity.findViewById(R.id.hotpoint);

            } else if (params.contains("礼物出现")) {
                System.out.println("礼物出现");
                //TODO
                view = mainActivity.findViewById(R.id.closegirl);


            } else if (params.contains("立刻降落")){
                System.out.println("立刻降落");
                view = mainActivity.findViewById(R.id.land);


            } else if (params.contains("拍照模式")){
                System.out.println("拍照模式");
                view = mainActivity.findViewById(R.id.takephoto);

            }else if (params.contains("起飞")){
                view = mainActivity.findViewById(R.id.takeoff);
            }else if (params.contains("升空")){
                view = mainActivity.findViewById(R.id.up);
            }
            if (view!=null){
